...
profile_menu_items = {
    ...
    'select_source': '8. Select source',
    'exit': '9. Quit program'
}

source_menu_items = {
    'source_notion': '1. Select Notion note',
    'source_pdf': '2. Select PDF file to load',
...
stages = {
    ...
    'profile_selected': ['new_profile', 'select_profile', 'edit_profile', 'select_source', 'exit'],
